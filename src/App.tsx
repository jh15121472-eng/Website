        ...
        <div className="container mx-auto px-8 py-20">
          <div className="relative z-10">
            ...
            <div className="text-center mb-8 md:mb-15">
              <h1 className="text-4xl sm:text-6xl md:text-8xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent text-glow-blue/30">
                Aamir Naqvi
              </h1>
