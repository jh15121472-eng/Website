        ...
        <div className="container mx-auto px-8 py-20">
          <div className="relative z-10">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="relative z-10 backdrop-blur-md border border-white/10 rounded-3xl p-6 md:p-12 shadow-lg bg-gradient-to-br from-[#0e006b]/20 via-[#130029]/20 to-[#00020d]/20">
